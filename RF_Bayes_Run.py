...
clf = RandomForestClassifier(n_estimators=252,max_depth=42)
...
exp.to_csv("F://RF_Bayes.csv")
export = DataFrame(y_test)
export.to_csv("F://RF_Bayes_predicted.csv")
print(probability_1)

probability = clf.predict_proba(x_1)
exp_1 = DataFrame(probability)
exp_1.to_csv("F://RF_Bayes_ALL.csv")
print(probability)
