...
def percept(args):
    ...
    ppn = RandomForestClassifier(n_estimators = int(args["n_estimators"]),max_depth=int(args['max_depth']),
...
space = dict(n_estimators=hp.quniform("n_estimators", 50, 500, 1), max_depth=hp.quniform('max_depth', 1,100,1),
